...
function goalsTopic(): HelpTopic {
  return {
    ...
    points: [
      ...
      "'הסרה מהיעדים' מוחקת את היעד ואי אפשר לבטל זאת: אין סטטוס 'בוטל' ואין ארכיון, ולא נשאר תיעוד שהיעד נבחר אי פעם. ההמלצה עצמה חוזרת להיות זמינה, ואפשר לבחור אותה שוב כיעד חדש.",
