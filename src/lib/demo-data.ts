...
export const wellbeingDimensions: WellbeingDimension[] = [
  {
    ...
    summary: [
      "רוב הצוות מרגיש שיש מקום להביע דעה ולהיות נוכח באופן אותנטי בעבודה.",
      "זהו מרכיב חזק שכדאי לשמר דרך שגרות שיח פתוחות וקבלת החלטות משתפת.",
    ],
    metrics: [
      {
        value: "82%",
  ...
  },
  {
    ...
    conceptStatusDirection: "up",
    summary: [
      "תחושת המסוגלות המקצועית יציבה, במיוחד בקרב צוות ותיק.",
      "כדאי לשים לב למורים חדשים שעדיין זקוקים לחיזוק מקצועי ולמשוב תדיר.",
    ],
    metrics: [
      {
        value: "76%",
  ...
  },
  {
    ...
    conceptStatusDirection: "up",
    summary: [
      "האווירה החברתית בבית הספר נתפסת כחיובית יחסית, אך עדיין קיימים פערים בתחושת הקרבה האישית והתמיכה הרגשית בקרב חברי הצוות.",
      "רבים מהמורים חווים קשרים טובים במקום העבודה, אך לא תמיד מרגישים שיש להם כתף תומכת ברגעים הקשים. מצב זה עשוי להעיד על תחושת בדידות תפקודית בתוך עומס העבודה.",
    ],
    metrics: [
      {
        value: "78%",
  ...
  },
  {
    ...
    conceptStatusDirection: "down",
    summary: [
      "ההנהלה נתפסת כזמינה, אך יש פער בין זמינות פורמלית לבין תחושת ביטחון לפנות בזמן אמת.",
      "זהו אזור שניתן לשפר במהירות באמצעות שגרות משוב ותיאום ציפיות.",
    ],
    metrics: [
      {
        value: "69",
  ...
  },
  {
    ...
    conceptStatusDirection: "down",
    summary: [
      "שינויים לא מתוכננים פוגעים בתחושת השליטה של חלק מהצוות.",
      "הפער אינו חריף, אך הוא משפיע על עומס רגשי ועל תכנון שבועי.",
    ],
    metrics: [
      {
        value: "58",
  ...
  },
  {
    ...
    conceptStatusDirection: "up",
    summary: [
      "התרבות הארגונית מאפשרת שיח על רווחה, במיוחד בצוותים קטנים.",
      "כדאי להרחיב את השפה המשותפת כך שלא תישאר תלויה ביוזמה אישית.",
    ],
    metrics: [
      {
        value: "71",
  ...
  },
  {
    ...
    conceptStatusDirection: "down",
    summary: [
      "תחושת המשמעות היא נקודת חוזק בולטת בבית הספר.",
      "הצוות רואה קשר ברור בין העבודה היומיומית לבין תרומה לתלמידים ולקהילה.",
    ],
    metrics: [
      {
        value: "88",
