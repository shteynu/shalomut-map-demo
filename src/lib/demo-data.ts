    ...
    recommendations: [
      {
        ...
        body: "קביעת שעות קצרות וקבועות שבהן ניתן לפנות להנהלה בלי תיאום מוקדם.",
      },
      {
        title: "גיבוי מפורש מול הורים",
        body: "מיסוד מדיניות ניהולית של גיבוי מלא למורים במקרים של קונפליקטים מול הורים או תלמידים.",
      },
      {
        title: "שיחות אישיות יזומות",
        body: "קיום שיחות קפה אישיות קצרות בין המנהל לכל איש צוות לפחות פעם ברבעון, ללא קשר לביצועים.",
      },
      {
        title: "משוב מעצים שוטף",
        body: "משלוח מכתב הוקרה קצר או ציון לשבח לאחר צפייה בשיעור או הובלת פרויקט מוצלח.",
      },
      {
        title: "פורום פתרון בעיות משותף",
        body: "הקמת קבוצה משותפת למנהלים ומורים להתייעצות מהירה וקבלת החלטות במצבים מורכבים.",
      },
    ],
  },
  {
