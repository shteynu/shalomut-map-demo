...
export const wellbeingDimensions: WellbeingDimension[] = [
  {
    ...
    recommendations: [
      {
        title: "שימור פורומים פתוחים",
        body: "המשך פתיחת ישיבות צוות עם מקום קצר להצפת רעיונות או חסמים.",
      },
      {
        title: "תיבת הצעות דיגיטלית",
        body: "אפשרו משלוח רעיונות או הערכות אנונימיות כדי לעודד את מי שחושש להשמיע קול בקול רם.",
      },
      {
        title: "סבב שיתוף במעגל קטן",
        body: "שילוב שיח שיתופי קצר בצוותים מצומצמים (עד 4 מורים) בתחילת ישיבות מפתח.",
      },
      {
        title: "יוזמות חינוכיות עצמאיות",
        body: "הקצאת תקציב קטן ותמיכה ניהולית ביוזמה פדגוגית של מורה אחת לרבעון.",
      },
      {
        title: "משוב פתוח דו-כיווני",
        body: "קיום שיחות חצי-שנתיות קבועות שבהן מורים יכולים להעריך באופן פתוח תהליכים ניהוליים.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        ...
        body: "שידוך בין מורה ותיק למורה חדש סביב אתגר הוראה אחד בכל חודש.",
      },
      {
        title: "קהילת למידת עמיתים",
        body: "הקמת קבוצות עבודה קבועות לפי מקצועות או שכבות גיל ללמידה הדדית של שיטות הוראה חדשניות.",
      },
      {
        title: "תצפיות ומשוב מעצים",
        body: "קיום תצפיות הדדיות בשיעורים מלוות בשיחת משוב ממוקדת חוזקות, לחיזוק הביטחון הפדגוגי.",
      },
      {
        title: "מאגר משאבים משותף",
        body: "ריכוז מערכי שיעור, מצגות, ופעילויות הפוגה דיגיטליות בתיקייה שיתופית נגישה לכלל המורים.",
      },
      {
        title: "פיתוח פדגוגי דיפרנציאלי",
        body: "מתן אפשרות לכל איש צוות לבחור קורס או השתלמות קצרים התואמים את היעדים המקצועיים שלו.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        ...
        body: "עידוד יצירת קשרים באמצעות מנטורינג: מורה ותיק שמלווה מורה חדש, או חיבורים יזומים בין צוותים.",
      },
      {
      ...
      },
      {
        ...
        body: "יצירת מרחב בטוח להעלאת תחושת ניתוק או עומס אישי וטיפול בהם יחד.",
      },
      {
        title: "פרגון והוקרה יומיומית",
        body: "עידוד מסגרות פשוטות של הוקרה: לוח מחמאות, דואר פרגון או דקות פרגון בישיבות צוות.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        ...
        body: "זיהוי צווארי בקבוק וויתור זמני על משימות שאינן קריטיות.",
      },
      {
        title: "גבולות תקשורת דיגיטלית",
        body: "הסכמה על שעות ללא הודעות ווטסאפ או מיילים (למשל, אחרי 19:00 ובסופי שבוע) להגנת שעות הפנאי.",
      },
      {
        title: "ייעול ישיבות שבועיות",
        body: "הגבלת משך ישיבות הצוות ל-45 דקות ומעבר לעדכונים כתובים ככל הניתן במקום מפגש פיזי.",
      },
      {
        title: "חלונות זמן לתכנון עצמאי",
        body: "שילוב חלון זמן ייעודי (לפחות שעה שבועית) במערכת של כל מורה לצורך תכנון ובדיקת עבודות ללא תורנות.",
      },
      {
        title: "פישוט בירוקרטיה",
        body: "ריכוז טפסים ודיווחים למערכת ממוחשבת אחת פשוטה להפחתת העומס המנהלתי המצטבר.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        title: "ערוץ פתוח להנהלה",
        body: "ביסוס נגישות ישירה, מהירה ובלתי אמצעית לצוות הניהול בעת הצורך.",
      },
      {
        title: "מעטפת גיבוי וביטחון מקצועי",
        body: "הבטחת תחושת מוגנות וגיבוי מערכתי מלא לצוות ההוראה מול קונפליקטים.",
      },
      {
        title: "שיח אישי וליווי שוטף",
        body: "טיפוח קשר אישי תקופתי ובלתי פורמלי בין המנהל לכל חבר צוות.",
      },
      {
        title: "תרבות של הוקרה והעצמה",
        body: "מיסוד שגרות של הוקרת תודה, הערכה וחיזוק החוזקות של חברי הצוות.",
      },
      {
        title: "שותפות וקבלת החלטות משותפת",
        body: "הובלת שיח משותף לפתרון מהיר ויעיל של דילמות מורכבות בשטח.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        ...
        body: "משלוח תמונת שבוע קצרה בכל יום חמישי עם שינויים צפויים.",
      },
      {
        title: "לוח אירועים שנתי קבוע",
        body: "פרסום לוח אירועים שקוף ומעודכן לכל שנת הלימודים, ומניעת שינויי תאריכים ברגע האחרון.",
      },
      {
        title: "פרוטוקול שינויי מערכת",
        body: "הגדרת נוהל ברור ומקדים להחלפת מורים או שינויי כיתות, תוך עדכון של לפחות 24 שעות מראש.",
      },
      {
        title: "בהירות בהגדרת תפקידים",
        body: "הפקת מסמך ציפיות והגדרת סמכויות ברור לכל בעל תפקיד ורכז בבית הספר.",
      },
      {
        title: "עדכון ממוקד לאחר החלטות",
        body: "הפצת סיכום כתוב ותמציתי לכלל הצוות מיד לאחר קבלת החלטה ניהולית או ישיבת רכזים.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        ...
        body: "הגדרה משותפת של אופן השיח על עומס רגשי ואילו ערוצי סיוע זמינים.",
      },
      {
        title: "שילוב סדנאות חוסן",
        body: "קיום סדנאות תקופתיות לצוות בנושאי מיינדפולנס, ניהול לחצים ומניעת שחיקה.",
      },
      {
        title: "מרחב הפוגה בבית הספר",
        body: "עיצוב מחדש של חדר המורים כמרחב נעים, שקט ומאפשר מנוחה והתרעננות בין שיעורים.",
      },
      {
        title: "תרבות הוקרה עמיתים",
        body: "מיסוד לוח פרגון דיגיטלי או פיזי שבו מורים יכולים להודות ולהחמיא לעמיתיהם בגלוי.",
      },
      {
        title: "ועדת רווחה ופנאי",
        body: "הקמת צוות מורים ובעלי תפקידים שיוביל פעילויות הפוגה, ימי הולדת וגיבוש חברתי שוטף.",
      },
    ],
  },
  {
    ...
    recommendations: [
      {
        title: "הבלטת סיפורי השפעה",
        body: "פתיחת ישיבות בסיפור קצר שמחבר בין מאמץ הצוות לתוצאה אצל תלמידים.",
      },
      {
        title: "לוח מכתבי תודה",
        body: "איסוף והצגה של מכתבי תודה והוקרה מתלמידים ובוגרים בחדר המורים.",
      },
      {
        title: "מפגשי רפלקציה על הצלחות",
        body: "הקדשת זמן בישיבות מורים לשיתוף ברגעי שיא וסיפורי הצלחה פדגוגיים או רגשיים עם תלמידים.",
      },
      {
        title: "חיבור לחזון בית הספר",
        body: "קיום שיח רבעוני המקשר בין העשייה השוטפת בכיתות לחזון החינוכי הרחב של בית הספר.",
      },
      {
        title: "הוקרת השפעה פנימית",
        body: "חלוקת תעודת מורה משפיע על ידי הצוות עצמו לפעילות מיוחדת המעוררת השראה.",
      },
    ],
  },
];
