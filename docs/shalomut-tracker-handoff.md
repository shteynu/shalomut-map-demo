...
Обновлено: 2026-07-28 (два окружения — локальное и задеплоенное; вебхук отвечает `202` и считает раунд фоном,
выкачено и проверено; задеплоенная база пуста, локальная засеяна)
