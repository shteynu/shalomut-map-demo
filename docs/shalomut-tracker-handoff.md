...
- **Ветка `feature/ai-insights-depth-v5` не запушена и не задеплоена (2026-07-28)**: 33 коммита поверх
  `origin/main` (`0a816e3`). Локальный `main` стоит ровно на `origin/main`. Push пробовали 2026-07-28 — отклонён
  на подтверждении прав, остаётся за владельцем. Всё описанное ниже в этом пункте живёт только в ветке — deployed
