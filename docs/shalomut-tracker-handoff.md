...
Обновлено: 2026-07-29 (контракт `5.0` включён и доказан на задеплоенном стеке, первые живые раунды прошли
сквозняком, темп обращений к провайдеру приведён к пяти в минуту — закоммичено, ждёт пуша владельца; открыто и
требует решения владельца: ротация четырёх секретов, засвеченных в переписке)
...
- **Темп обращений приведён к тарифу (2026-07-29; закоммичено `794c9b1`, на деплой ещё не ушло)**.
