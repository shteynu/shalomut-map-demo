...
больше не блокер; закрыты пункты 8 и 15–21. Пункт 10 остаётся открытым решением владельца. Единственный
...
4. **Пункт 10** — не блокер, а отложенное решение. Расчёт по нему изменился в эту сессию: на `5.0` отказ
   измерения больше не убивает раунд, подробности в самом пункте.
