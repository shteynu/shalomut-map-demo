...
Обновлено: 2026-07-29 (**первый живой раунд завершился `success`, все восемь камней написаны моделью**;
квота больше не блокер; отказы адаптации разобраны и исправлены; открыто и требует решения владельца:
