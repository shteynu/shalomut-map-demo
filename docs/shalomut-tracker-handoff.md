...
на транспорт / промпты / валидацию; локально, ничего не закоммичено и не задеплоено)
...
- **Раунд больше не приходит к провайдеру одним залпом (2026-07-29; локально, не закоммичено)**.
...
- **`llm_provider.py` разделён по ответственности (2026-07-29; локально, не закоммичено)**. Было 1323 строки в
