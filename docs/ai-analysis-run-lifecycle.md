...
| worker → Core | `POST /api/ai-analysis-runs/:id/heartbeat` | `AI_CALLBACK_SECRET` | 200 · 409 · 400 |
| worker → Core | `POST /api/ai-analysis-runs/:id/fail` | `AI_CALLBACK_SECRET` | 200 · 404 · 409 |
